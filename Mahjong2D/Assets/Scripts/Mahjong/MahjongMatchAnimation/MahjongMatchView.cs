...
public class MahjongMatchView : View
{
    ...
    public void Play(Vector3 first, Vector3 second, Vector2 cardSize, Sprite sprite)
    {
        if (parent == null)
        {
            Debug.LogError(
        ...
        Vector2 firstPosition = new(first.x, first.y);
        Vector2 secondPosition = new(second.x, second.y);
