...
public class StateMachine_Game : IStateProvider
{
    ...
    public StateMachine_Game(DIContainer container)
    {
        ...
        states[typeof(WinVideoState_Game)] = new WinVideoState_Game(this, root, container.Resolve<ILevelProvider>(), container.Resolve<IMahjongScoreProvider>(), container.Resolve<IMahjongRewardProvider>());
