...
public class StateMachine_Game : IStateProvider
{
    ...
    public StateMachine_Game(DIContainer container)
    {
        ...
        var soundProvider = container.Resolve<ISoundProvider>();
        ...
        states[typeof(WinVideoState_Game)] = new WinVideoState_Game(this, root, container.Resolve<ILevelProvider>(), container.Resolve<IMahjongScoreProvider>(), container.Resolve<IMahjongRewardProvider>(), soundProvider);
        states[typeof(WinState_Game)] = new WinState_Game(sceneService, root);

        states[typeof(LoseVideoState_Game)] = new LoseVideoState_Game(this, root, soundProvider);
